<template>
  <div v-on:click="open = !open">
    <button
      type="button"
      class="inline-flex items-center rounded-md px-8 py-2 text-base font-medium text-white bg-blue-600 shadow-sm tracking-wider"
    >
      Add Category
    </button>
  </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <h3 class="font-semibold text-xl">New Category</h3>
